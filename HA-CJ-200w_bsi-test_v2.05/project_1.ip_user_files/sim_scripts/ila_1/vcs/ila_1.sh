...
#
# Generated by Vivado on Fri Sep 20 15:40:46 +0800 2024
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../project_1.gen/sources_1/ip/ila_1/hdl/verilog" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../project_1.gen/sources_1/ip/ila_1/hdl/verilog" \
    "$ref_dir/../../../../project_1.gen/sources_1/ip/ila_1/sim/ila_1.v" \
  2>&1 | tee -a vlogan.log
