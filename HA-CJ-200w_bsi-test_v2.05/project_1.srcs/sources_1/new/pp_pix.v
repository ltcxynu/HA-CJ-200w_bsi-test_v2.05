...
module pp_pix #(
  ...
  input [9:0] pix_raddr_i,
  input pix_rd_i,
  input [9:0] pix_waddr_i,
  input [275:0] pix_wdata_i,
  input pix_wr_i,
  output [275:0] pix_rdata_o
);

wire [11:0] pix_mem_raddr;
wire pix_mem_rd_n;
wire [275:0] pix_mem_rdata;
wire [11:0] pix_mem_waddr;
wire [275:0] pix_mem_wdata;
wire pix_mem_wr_n;
