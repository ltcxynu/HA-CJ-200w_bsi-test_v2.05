...
HD_PWD='E:/HA-CJ-200w_bsi-test_v2.05/HA-CJ-200w_bsi-test_v2.05/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cj_200w_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cj_200w_top.tcl
